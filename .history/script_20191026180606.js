function newTodo() {
    ...
    todoCheckbox.addEventListener('click', function(){this.nextElementSibling.classList.toggle('checked')});
    todoRemove.classList.add('remove');
    todoRemove.textContent = 'X';
    todoRemove.addEventListener('click', function () { this.parentNode.remove() });
